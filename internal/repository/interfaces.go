...
type AgentRepositoryInterface interface {
	CreateAgent(userId, name, description, aiModel string, agentType entity.AgentType, capabilities []string, credit_per_1k int, status entity.AgentStatus) (*entity.Agent, error)
